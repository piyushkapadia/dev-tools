...
(push "D:/Dev/Home/.emacs.d/private/themes/lambda-themes/" load-path)
(push "D:/Dev/Home/.emacs.d/private/themes/" load-path)
...
;; https://stackoverflow.com/questions/6400447/how-to-install-a-emacs-plugin-many-times-its-a-el-file-on-windows-platform  
;; https://emacs.stackexchange.com/questions/3310/difference-between-load-file-and-load
;; https://www.reddit.com/r/emacs/comments/ml1xny/load_custom_el_file_for_initel/
;; https://github.com/syl20bnr/spacemacs/issues/1639
(add-to-list 'load-path "~/.emacs.d/private/custom-layer/external-packages")
(load "redo+.el")
;;(load "windows-keys.el")
;;(require 'windows-keys)  
